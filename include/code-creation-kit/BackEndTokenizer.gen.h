        ...
        ThisT& operator <<( const StringT& line)
        {
            ...
            while(m_tokenFinder.find_token(textBegin, textEnd, tokenBegin, tokenEnd, index)) 
            {
                ...
                else if ( tokenData.ParseFunction )
                {
                    ...
                    if ( isLoggingEnabled())
                    {
                        *m_pOutputStream << TokenT( tokenData.TokenId, list, getSourceText( tokenBegin, dotsBegin, dotsEnd, textBegin /*has been updated*/));
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if ( isLoggingEnabled())
                    {
                        *m_pOutputStream << TokenT( tokenData.TokenId, SharedStringListT(), getSourceText( tokenBegin, dotsBegin, dotsEnd, tokenEnd));
                    }
                    else
                    {
